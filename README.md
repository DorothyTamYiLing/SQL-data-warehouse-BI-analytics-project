...
Figure 9 (screenshot): Boxplot of monthly moving average of price (See also Figure 8) This boxplot was produced using python script in PowerBI Desktop (See file)
